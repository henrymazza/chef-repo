...
set['postgresql']['client']['packages']  = ["postgresql-client-9.3"]
set['postgresql']['server']['packages']  = ["postgresql-9.3"]
set['postgresql']['contrib']['packages'] = ["postgresql-contrib-9.3"]
